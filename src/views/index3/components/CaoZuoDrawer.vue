<template>
    <div class="rightWarp">
        ...
        <div class="list" v-if="showOptions">
            ...
            <div class="little_title">操作类型：</div>
            <CheckButtonList :data="checkedButtonDics1" v-model="defaultData.handleType"></CheckButtonList>
            <UserPicker v-model="defaultData.userId"></UserPicker>
        </div>
    </div>
</template>
<script>
    ...
    import UserPicker from "@/components/searchPicker/UserPicker";
    ...
    export default {
        ...
        methods: {
            ...
            searchReset() {
                ...
                this.defaultData.handleType = []
                this.defaultData.userId = ''
                this.searchOk();
            },
            searchOk() {
